                                ...
                                <li class="a-news wow fadeIn  animated" id="post-3217" style="visibility: visible; animation-name: fadeIn;">
                                    <div class="a-news-img">
                                        <div class="a-news-img-inside">
                                            <a href="{{route('getOneEvent',$event->name)}}" class="display: block;"><img width="738" height="378" src="{{$event->cover_image}}" class="attachment-tintuc size-tintuc wp-post-image" alt="Thiết kế không tên"></a>
                                        </div>
                                    </div>
                                    <div class="a-news-info">
                                        <a href="{{route('getOneEvent',$event->name)}}">{{$event->name}}</a>
                                        <p>
